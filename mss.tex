...
In current Arvo, when a comet contacts another ship, that ship will ask the comet for an \emph{unencrypted self-attestation packet} to prove that the sender does in fact control the private key whose public counterpart was hashed into the comet's \lstinline[style=inlinecode]{@p}:
